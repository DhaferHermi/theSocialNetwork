 ...
 */
class getListGroupRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ListGroupRepository' shared autowired service.
     *
     * @return \App\Repository\ListGroupRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ListGroupRepository.php';

        return $container->privates['App\\Repository\\ListGroupRepository'] = new \App\Repository\ListGroupRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
